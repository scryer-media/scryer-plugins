...
fn jellyfin_release_wasm_conforms_to_the_notification_host_contract() {
    NotificationConformance::new(env!("CARGO_MANIFEST_DIR"), "jellyfin")
        .wasm("jellyfin_notification.wasm")
        .config("base_url", "https://jellyfin.test.invalid")
        .config("api_key", "jellyfinkey")
        .expects_url_prefix("https://jellyfin.test.invalid/System/Info")
