...
const PLUGIN_ID: &str = "jellyfin";
const PROVIDER_TYPE: &str = "jellyfin";
const WASM_NAME: &str = "jellyfin_notification.wasm";

/// The configuration Scryer would have resolved for this channel.
fn scripted_config(key: &str) -> Option<String> {
    match key {
        "base_url" => Some("https://jellyfin.test.invalid".to_string()),
        "api_key" => Some("jellyfinkey".to_string()),
        _ => None,
    }
}
...
const EXPECTED_URL_PREFIX: &str = "https://jellyfin.test.invalid/System/Info";

static PLUGIN_WASM: OnceLock<PathBuf> = OnceLock::new();

#[test]
fn jellyfin_release_wasm_conforms_to_the_notification_host_contract() {
