...
const EXPECTED_URL_PREFIX: &str = "https://api.prowlapp.com/publicapi/add";

static PLUGIN_WASM: OnceLock<PathBuf> = OnceLock::new();

#[test]
fn prowl_release_wasm_conforms_to_the_notification_host_contract() {
