...
const EXPECTED_URL_PREFIX: &str = "https://joinjoaomgcd.appspot.com/_ah/api/messaging/v1/sendPush?deviceId=group.all&apikey=joinkey";

static PLUGIN_WASM: OnceLock<PathBuf> = OnceLock::new();

#[test]
fn join_release_wasm_conforms_to_the_notification_host_contract() {
