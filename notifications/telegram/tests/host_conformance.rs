...
const WASM_NAME: &str = "telegram_notification.wasm";
...
fn scripted_config(key: &str) -> Option<String> {
    match key {
        ...
        "bot_token" => Some("bottoken".to_string()),
        _ => None,
    }
}
...
const EXPECTED_URL_PREFIX: &str = "https://api.telegram.org/botbottoken/sendmessage";
