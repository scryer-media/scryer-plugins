...
const WASM_NAME: &str = "slack_notification.wasm";

/// The configuration Scryer would have resolved for this channel.
fn scripted_config(key: &str) -> Option<String> {
    match key {
        "webhook_url" => Some("https://slack.test.invalid/services/T/B/token".to_string()),
        _ => None,
    }
}
...
const EXPECTED_URL_PREFIX: &str = "https://slack.test.invalid/services/T/B/token";
