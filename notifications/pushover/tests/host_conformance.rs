...
const PLUGIN_ID: &str = "pushover";
const PROVIDER_TYPE: &str = "pushover";
const WASM_NAME: &str = "pushover_notification.wasm";

/// The configuration Scryer would have resolved for this channel.
fn scripted_config(key: &str) -> Option<String> {
    match key {
        "api_key" => Some("pushoverkey".to_string()),
        "user_key" => Some("pushoveruser".to_string()),
        _ => None,
    }
}
...
const EXPECTED_URL_PREFIX: &str = "https://api.pushover.net/1/messages.json";
