...
const PLUGIN_ID: &str = "emby";
const PROVIDER_TYPE: &str = "emby";
const WASM_NAME: &str = "emby_notification.wasm";

/// The configuration Scryer would have resolved for this channel.
fn scripted_config(key: &str) -> Option<String> {
    match key {
        "base_url" => Some("https://emby.test.invalid".to_string()),
        "api_key" => Some("embykey".to_string()),
        _ => None,
    }
}
...
const EXPECTED_URL_PREFIX: &str = "https://emby.test.invalid/System/Info";
