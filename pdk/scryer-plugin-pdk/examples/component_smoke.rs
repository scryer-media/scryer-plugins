...
async fn search(_request: sdk::PluginSearchRequest) -> Result<sdk::PluginSearchResponse, Error> {
    Ok(sdk::PluginSearchResponse::default())
}

scryer_plugin_pdk::scryer_indexer_component_main!(descriptor = descriptor, search = search,);
